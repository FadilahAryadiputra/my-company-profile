        ...
        {({ setFieldValue }) => (
          <Form className='space-y-4'>
              ...
              {selectedImage ? (
                ...
                <div className='grid gap-2'>
                  ...
                  <Input
                    ...
                    className='bg-white text-neutral-500 hover:bg-gray-200 active:bg-gray-300'
                  />
                  <ErrorMessage
                    name='thumbnail'
                    component='p'
            ...
            <div className='flex justify-end'>
              <Button type='submit' disabled={isPending} className='border-gray-400 border-1 hover:bg-gray-500 active:bg-gray-600'>
