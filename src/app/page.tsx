  ...
  return (
    <main>
          ...
          <div className='flex justify-between p-4 text-white min-h-screen'>
            <div className='mx-0 md:mx-10 my-20 flex items-center gap-2'>
              <div className='grid gap-4 md:grid-cols-2 md:gap-16'>
                <div className='flex flex-col px-6 lg:px-10 justify-between'>
      ...
      <section className='bg-white w-full'>
        <div className='container mx-auto py-4'>
          <div className='flex flex-col items-center justify-center py-16 px-8 md:px-16  lg:px-24 gap-4 '>
            ...
            <div className='grid grid-cols-1 gap-12 mt-4 sm:grid-cols-2 lg:grid-cols-3'>
              ...
              <CarouselContent>
                <CarouselItem>
                  <Card className='bg-gray-200'>
                    <CardContent className='flex flex-col text-center items-center justify-center px-8 md:px-24 pt-0 md:pt-2 pb-12 gap-2 md:gap-4'>
                      <div className='bg-black rounded-full size-[80px] md:size-[120px] overflow-hidden'>
                        <Image
